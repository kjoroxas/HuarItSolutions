    ...
    <form id="form1" runat="server">
                <div>
                    <div class="card " style="width: 106rem; height:44rem;">
                         <div class="card-body">
                         <h5 class="subtitle"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"><g fill="currentColor"><rect width="5" height="18" x="16" y="3" rx="2"/><rect width="5" height="12" x="9.5" y="9" rx="2"/><rect width="5" height="5" x="3" y="16" rx="2"/></g></svg> Sales Representative</h5>
                             <div style="margin-left:40px;" class="row" id="firstrow">
                                ...
                                <div  class="col-4">
                                   ...
                                   <asp:TextBox ID="outletCodetext" CssClass="textbox2"  ValidateRequestMode="Disabled" type="text" runat="server" ></asp:TextBox><br />
                                   ...
                                   <label class="subheader" style=" margin-top: 15px; margin-right:77px;"><small>Address</small></label>
                                    <asp:TextBox ID="address" Height="60px" Width="500px" TextMode="MultiLine" Rows="3" CssClass="paragraph-style textbox no-resize" ValidateRequestMode="Disabled" type="text" runat="server"  ></asp:TextBox><br />

                                    <label class="subheader" style=" margin-top: 15px; margin-right:72px;"><small>Area</small></label>
                                    <asp:DropDownList ID="areaCode" Height="40px" CssClass="gameCodeDropDown" runat="server"></asp:DropDownList><br />
                                   ...
                                   <label class="subheader" style=" margin-top: 15px; margin-right:22px;"><small>Mobile Number</small></label>
                                    ...
                                    <label class="subheader" style=" margin-top: 15px; margin-right:65px;"><small>Password</small></label>
                                    ...
                                    <asp:DropDownList ID="commisionType" Height="40px" CssClass="gameCodeDropDown" runat="server"></asp:DropDownList><br />
                                    <label class="subheader" style=" margin-top: 15px; margin-right:3px;"><small>Back Pay Type</small></label>
                                    <asp:DropDownList ID="backPayType" Height="40px" CssClass="gameCodeDropDown" runat="server"></asp:DropDownList><br />
                                    <label class="subheader" style=" margin-top: 15px; margin-right:70px;"><small>Location</small></label>
                                    <asp:TextBox ID="location" Height="40px" ValidateRequestMode="Disabled" type="text" runat="server"  ></asp:TextBox><asp:Button runat="server" id="setbutton"  Text="Set" CssClass="small-font clearbutton" Height="40px" Width="50px"/><br />
                                    <asp:CheckBox ID="isActive" CssClass="ActiveCheckbox" runat="server" /><label class="subheader"><small>Active</small></label><br />
                                    </div>
