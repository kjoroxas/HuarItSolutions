            ...
            <div id="sidettons" class="col-sm-auto  sticky-top custom-column-spacing ">
                ...
                <div class="d-flex flex-sm-column flex-row  flex-nowrap  align-items-center sticky-top ">
                    ...
                    <div id="content" class="col-lg-2"  >
                        ...
                        <div  class="card " style="width: 106rem; height:44rem; margin-top:20px;">
                        <div class="row-lg-7"  >
                            <div class="tab-content" >
                                        <div id="active" class="tab-pane fade show active" role="tabpanel" aria-labelledby="agame">
                                             <iframe src="GameSettingsMenu/active_games.aspx" scrolling="no" style="width: 106rem; height:44rem; border:none; "></iframe>
                                        </div>
                                        <div id="combi" class=" tab-pane fade" role="tabpanel" aria-labelledby="combine">
                                             <iframe src="GameSettingsMenu/controlled_combinations.aspx" scrolling="no" style="width: 106rem; height:44rem; border:none; "></iframe>
                                        </div>
                                        <div id="lowcombi" class=" tab-pane fade" role="tabpanel" aria-labelledby="lowb">
                                             <iframe src="GameSettingsMenu/low_winning_combinations.aspx" scrolling="no" style="width: 106rem; height:44rem; border:none; "></iframe>
                                        </div>
                                        ...
                                        <div id="salesrep" class=" tab-pane fade" role="tabpanel" aria-labelledby="salesr">
                                               <iframe src="GameSettingsMenu/sales_representative.aspx" scrolling="no" style="width: 106rem; height:44rem; overflow:hidden;  "></iframe>
                                        </div>
                            </div>
                        </div>
                    </div>
