               ...
               <div class="col-sm-3 pcversion">
                   <div class="row">
                    <label class="subheader" style=" margin-top:3px; margin-left:-10px;">Draw Date</label><br />
                        <asp:TextBox ID="drawDate" CssClass="textbox6" runat="server" TextMode="Date"></asp:TextBox><br />

                        <label class="subheader" style=" margin-top:33px;  margin-left:-10px;">Transaction Number</label><br />
                          <asp:TextBox ID="TextBox1" CssClass="textbox6" runat="server"></asp:TextBox><br />
                            <label class="subheader" style=" margin-top:33px;  margin-left:-10px;">Outlet Code</label><br />
                            <asp:TextBox ID="TextBox2" CssClass="textbox6" runat="server"></asp:TextBox><br />
                            <asp:Button ID="Button1" CSSClass="viewBtnclass" runat="server" Text="Search" />
                             <asp:Button ID="Button4" CSSClass="viewBtnclass" runat="server" Text="Delete"  />
                       </div>
                   </div>
       <div class="col-8">
                                        <div class="tablestyle4">
                 <table id="validationtable" class="table table-striped table-bordered table-responsive" style="width:100%">
                         <thead>
                             <tr>
